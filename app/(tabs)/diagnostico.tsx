                    ...
                    <View style={styles.formContainer}>
                        ...
                        <View style={styles.section}>
                            ...
                            <View style={styles.textAreaContainer}>
                                ...
                                />
                                <TouchableOpacity
                                    style={[styles.voiceButton, { backgroundColor: isListeningSymptoms ? "#ef4444" : "transparent" }]}
                                    onPress={() => startListeningSymptoms((text) => setSymptoms(prev => prev ? `${prev} ${text}` : text))}
                                >
                                    <Ionicons name={isListeningSymptoms ? "mic" : "mic-outline"} size={22} color={isListeningSymptoms ? "#fff" : "#3b82f6"} />
                                </TouchableOpacity>
                            </View>
                        </View>
